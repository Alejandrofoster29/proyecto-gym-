            ...
            <form action="../../../../back_end/controladores/entrenador_control.php" method="POST" enctype="multipart/form-data" class="needs-validation">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $entrenador->nombre ?>" required>
                        <div class="invalid-feedback">
                            Por favor ingrese todos los campos.
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?php echo $entrenador->apellidos ?>" required>
                        <div class="invalid-feedback">
                            Por favor ingrese todos los campos.
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="tel" class="form-control" id="edad" name="edad" value="<?php echo $entrenador->edad ?>" required>
                        <div class="invalid-feedback">
                            Por favor ingrese todos los campos.
                        </div>
                    </div>
