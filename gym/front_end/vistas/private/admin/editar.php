...
<body>
    ...
    <main class="container">
        <div>
            <form action="../../../../back_end/controladores/admin_control.php" method="POST" enctype="multipart/form-data" class="needs-validation">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" class="form-control" id="contrasena" name="contrasena" value="<?php echo $admin->contrasena ?>" required>
                        <div class="invalid-feedback">
                            Por favor ingrese todos los campos.
                        </div>
                    </div>
