...
<body class="text-center">
  ...
  <form class="form-signin" method="POST" action="../../../../back_end/controladores/sesion_control.php">
    ...
    <img class="mb-4" src="../../public/imagenes/logo.jpg" alt="" width="72" height="72">
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit" data-toggle="modal" data-target="#exampleModal">Sign in</button>
  </form>
